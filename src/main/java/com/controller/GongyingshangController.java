...
public class GongyingshangController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		GongyingshangEntity u = gongyingshangService.selectOne(new EntityWrapper<GongyingshangEntity>().eq("gongyingshangzhanghao", username));
    ...
    public R register(@RequestBody GongyingshangEntity gongyingshang){
    	...
    	GongyingshangEntity u = gongyingshangService.selectOne(new EntityWrapper<GongyingshangEntity>().eq("gongyingshangzhanghao", gongyingshang.getGongyingshangzhanghao()));
		if(u!=null) {
