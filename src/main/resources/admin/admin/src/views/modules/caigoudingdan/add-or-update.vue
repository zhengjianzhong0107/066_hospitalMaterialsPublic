	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="采购数量" prop="caigoushuliang">
					<el-input v-model="ruleForm.caigoushuliang" placeholder="采购数量" clearable  :readonly="ro.caigoushuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="采购数量" prop="caigoushuliang">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="采购时间" prop="caigoushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.caigoushijian" label="采购时间" prop="caigoushijian">
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(json.yiyuanzhanghao!=''&&json.yiyuanzhanghao && this.$storage.get("role")!="管理员"){
						this.ruleForm.yiyuanzhanghao = json.yiyuanzhanghao
						this.ro.yiyuanzhanghao = true;
					}
					if(json.yiyuanmingcheng!=''&&json.yiyuanmingcheng && this.$storage.get("role")!="管理员"){
						this.ruleForm.yiyuanmingcheng = json.yiyuanmingcheng
						this.ro.yiyuanmingcheng = true;
					}
					if(json.yiyuandianhua!=''&&json.yiyuandianhua && this.$storage.get("role")!="管理员"){
